...
public class Indexer {
    ...
    public void createIndex(String indexPath, String docsPath) {

        deleteDirectory(new File(indexPath));
        ...
        try {
            ...
            double timeInMin = (double) (end.getTime() - start.getTime()) / 1000.0 / 60.0;
            System.out.println(timeInMin + " minutes");
